# [SEOJEV-ENG-072] [SEOJEV-ENG-072] Routine hygiene cleanup: review template template template page has nofollow on ...
...
Observed 1 URLs in template 'tpl_listing_ather-energy_2seg' with issue 'cluster_template_template_template_page_has_nofollow': Observed on 2 URLs across 1 templates. Primary concentration in 'tpl_listing_ather-energy_2seg' (2 pages affected, 100.0% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template template template page has nofollow on affected pages.
