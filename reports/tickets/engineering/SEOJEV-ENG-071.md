# [SEOJEV-ENG-071] [SEOJEV-ENG-071] Routine hygiene cleanup: review template template template canonical mismatch on...
...
Observed 1 URLs in template 'tpl_brand_scooters_2seg' with issue 'cluster_template_template_template_canonical_mismatch': Observed on 2 URLs across 1 templates. Primary concentration in 'tpl_brand_scooters_2seg' (2 pages affected, 100.0% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template template template canonical mismatch on affected pages.
