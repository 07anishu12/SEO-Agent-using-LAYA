# [SEOJEV-ENG-048] [SEOJEV-ENG-048] Routine hygiene cleanup: review template canonical mismatch on affected pages.
...
Observed 5 URLs in template 'tpl_article_featured-stories_2seg' with issue 'cluster_template_canonical_mismatch': Observed on 96 URLs across 12 templates. Primary concentration in 'tpl_article_featured-stories_2seg' (8 pages affected, 8.3% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template canonical mismatch on affected pages.
