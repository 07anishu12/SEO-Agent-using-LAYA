# [SEOJEV-ENG-123] [SEOJEV-ENG-123] Routine hygiene cleanup: review missing image alt on affected pages.
...
Observed 5 URLs in template 'tpl_article_news_2seg' with issue 'cluster_missing_image_alt': Observed on 5,001 URLs across 411 templates. Primary concentration in 'tpl_article_news_2seg' (494 pages affected, 9.9% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review missing image alt on affected pages.
