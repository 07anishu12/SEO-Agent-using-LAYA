# [SEOJEV-ENG-067] [SEOJEV-ENG-067] Routine hygiene cleanup: review template weakly linked page on affected pages.
...
Observed 1 URLs in template 'tpl_listing_careers_2seg' with issue 'cluster_template_weakly_linked_page': Observed on 8 URLs across 1 templates. Primary concentration in 'tpl_listing_careers_2seg' (8 pages affected, 100.0% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template weakly linked page on affected pages.
