# [SEOJEV-ENG-063] [SEOJEV-ENG-063] Routine hygiene cleanup: review template template template page has noindex on a...
...
Observed 2 URLs in template 'tpl_comparison_compare_2seg' with issue 'cluster_template_template_template_page_has_noindex': Observed on 4 URLs across 2 templates. Primary concentration in 'tpl_comparison_compare_2seg' (2 pages affected, 50.0% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template template template page has noindex on affected pages.
