# [SEOJEV-ENG-059] [SEOJEV-ENG-059] Routine hygiene cleanup: review template page has noindex on affected pages.
...
Observed 2 URLs in template 'tpl_comparison_compare_2seg' with issue 'cluster_template_page_has_noindex': Observed on 16 URLs across 2 templates. Primary concentration in 'tpl_comparison_compare_2seg' (8 pages affected, 50.0% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template page has noindex on affected pages.
