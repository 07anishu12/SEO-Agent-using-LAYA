# [SEOJEV-ENG-032] [SEOJEV-ENG-032] Routine hygiene cleanup: review template missing image dimensions on affected pa...
...
Observed 5 URLs in template 'tpl_article_featured-stories_2seg' with issue 'cluster_template_missing_image_dimensions': Observed on 920 URLs across 115 templates. Primary concentration in 'tpl_article_featured-stories_2seg' (8 pages affected, 0.9% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template missing image dimensions on affected pages.
