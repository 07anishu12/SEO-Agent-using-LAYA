# [SEOJEV-ENG-034] [SEOJEV-ENG-034] Routine hygiene cleanup: review template template duplicate meta description on ...
...
Observed 5 URLs in template 'tpl_brand_husqvarna-motorcycles_2seg' with issue 'cluster_template_template_duplicate_meta_description': Observed on 422 URLs across 156 templates. Primary concentration in 'tpl_brand_husqvarna-motorcycles_2seg' (4 pages affected, 0.9% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template template duplicate meta description on affected pages.
