# [SEOJEV-ENG-052] [SEOJEV-ENG-052] Routine hygiene cleanup: review template template template duplicate meta descri...
...
Observed 5 URLs in template 'tpl_brand_husqvarna-motorcycles_2seg' with issue 'cluster_template_template_template_duplicate_meta_description': Observed on 48 URLs across 48 templates. Primary concentration in 'tpl_brand_husqvarna-motorcycles_2seg' (1 pages affected, 2.1% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template template template duplicate meta description on affected pages.
