# [SEOJEV-ENG-066] [SEOJEV-ENG-066] Routine hygiene cleanup: review template page has nofollow on affected pages.
...
Observed 1 URLs in template 'tpl_listing_ather-energy_2seg' with issue 'cluster_template_page_has_nofollow': Observed on 8 URLs across 1 templates. Primary concentration in 'tpl_listing_ather-energy_2seg' (8 pages affected, 100.0% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template page has nofollow on affected pages.
