# [SEOJEV-ENG-037] [SEOJEV-ENG-037] Routine hygiene cleanup: review template template empty anchor text on affected ...
...
Observed 5 URLs in template 'tpl_brand_husqvarna-motorcycles_2seg' with issue 'cluster_template_template_empty_anchor_text': Observed on 373 URLs across 83 templates. Primary concentration in 'tpl_brand_husqvarna-motorcycles_2seg' (5 pages affected, 1.3% of total occurrences)..
...
Action Required: Routine hygiene cleanup: review template template empty anchor text on affected pages.
